...
fn process_badge(name: String, attrs: BTreeMap<String, String>) -> String {
    match name.as_ref() {
        ...
        "circle-ci" => {
            ...
            format!("[![Build status](https://circleci.com/{service}/{repo}/tree/{branch}.svg?style=svg)](https://circleci.com/{service}/{repo}/cargo-readme/tree/{branch})",
        ...
        "gitlab" => {
            ...
            format!("[![Build status](https://gitlab.com/{repo}/badges/{branch}/build.svg)](https://gitlab.com/{repo}/commits/master)",
        ...
        "travis-ci" => {
            ...
            format!("[![Build Status](https://travis-ci.org/{repo}.svg?branch={branch})](https://travis-ci.org/{repo})",
                repo=repo, branch=percent_encode(branch))
        }
        "codecov" => {
            let repo = attrs["repository"];
            ...
            format!("[![codecov](https://codecov.io/{service}/{repo}/branch/{branch}/graph/badge.svg)](https://codecov.io/{service}/{repo})",
